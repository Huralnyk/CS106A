...
public class InteractiveDrawFace extends GraphicsProgram {
	...
	private void initColorChooser() {
		...
		pickColor = new JComboBox();	// instance variable
	...
	// Called every time user click mouse
	public void mouseClicked(MouseEvent e) {
		GObject obj;
		double diam = getDiamSize();
		if (checkbox.isSelected()) {
			obj = new GFace(diam, diam);	// Draw front of the face
		} else {
			obj = new GOval(diam, diam);	// Draw "back" of the face
		}
